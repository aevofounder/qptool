...
export const FALLBACK_ARTICLES = [
  {
    id: 1,
    slug: "kak-vybrat-frezu-pod-material",
    title: "Как выбрать фрезу под конкретный материал",
    category_label: "Технологии",
    published_at: "2026-06-12",
    excerpt:
      "Марка обрабатываемого материала напрямую влияет на выбор геометрии, покрытия и числа зубьев фрезы. Разбираем базовые принципы подбора.",
  },
  {
    id: 2,
    slug: "osnaschenie-stanka-chpu-s-chego-nachat",
    title: "Оснащение станка с ЧПУ: с чего начать",
    category_label: "Оснастка",
    published_at: "2026-06-04",
    excerpt:
      "Комплексное оснащение станка начинается с аудита парка и задач. Показываем, как выстроить номенклатуру инструмента и оснастки.",
  },
  {
    id: 3,
    slug: "snizhaem-stoimost-instrumenta-na-20",
    title: "Снижаем стоимость инструмента на 20%",
    category_label: "Экономика",
    published_at: "2026-05-28",
    excerpt:
      "Оптимизация номенклатуры и режимов резания позволяет заметно сократить затраты на инструмент без потери качества обработки.",
  },
];
